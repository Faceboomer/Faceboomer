...
function preload() {
    ...
    for (let file of backgroundFiles) {
        backgrounds.push(loadImage('data/brilhos/' + file));
    }
}
...
function setup() {
    ...
    for (var i = 0; i < 4; i++) {
        ...
        bgBtn[i].position(btnPosX * i + margem, btnPosY + 150);
    ...
    for (var i = 4; i < 8; i++) {
        ...
        bgBtn[i].position(btnPosX * i + + margem - (btnPosX * 7), btnPosY + 200);
        bgBtn[i].style('width', '60px');
        bgBtn[i].style('height', '60px');
        bgBtn[i].style('border', 'solid 0.5px #af7dfd');
        bgBtn[i].style('background-size', 'cover');
    ...
    bgBtn[0].style('background-image', 'url("data/brilhos/brilho1.png")');
    bgBtn[1].style('background-image', 'url("data/brilhos/brilho2.png")');
    bgBtn[2].style('background-image', 'url("data/brilhos/brilho3.png")');
    bgBtn[3].style('background-image', 'url("data/brilhos/brilho4png")');
    bgBtn[4].style('background-image', 'url("data/brilhos/brilho5.png")');
    bgBtn[5].style('background-image', 'url("data/brilhos/brilho6.png")');
    bgBtn[6].style('background-image', 'url("data/brilhos/brilho7.png")');
    bgBtn[7].style('background-image', 'url("data/brilhos/brilho8.png")');
...
function showBg2() {
    a = 0;
    image(backgrounds[2], 0, 0+header0, windowWidth, windowWidth);
}
function showBg3() {
    a = 0;
...
function showBg8() {
    a = 0;
    image(backgrounds[8], 0, 0+header, windowWidth, windowWidth);
}
